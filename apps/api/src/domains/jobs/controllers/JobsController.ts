...
import { RUNNER_SERVICE } from "../../pipelines/keys"
import { RunnerService } from "../../pipelines/services/runner.service"
...
export class JobsController {
  constructor(
    ...
    this.socket.on("test", (data) => console.log("Test event", data))
  }
